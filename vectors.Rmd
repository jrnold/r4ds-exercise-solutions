...
It considers `Inf` and `-Inf` to be infinite, and everything else, including non-missing numbers, `NA`, and `NaN` to not be infinite. See Table \@ref(finite-infinite).

Table: (\#finite-infinite) Results of `is.finite()` and `is.infinite()` for 
