...
Read the documentation of `parse_number()`. In order to ignore things like currency symbols and comma separators in number strings it ignores them using a heuristic.
...
1.  This function returns a the elements of a vector that are even numbers.
    ...
    even_numbers <- function(x) {
      x[!is.na(x) & !is.infinite(x) & (x %% 2 == 0)]
    }
    even_numbers(-10:10)
    even_numbers(c(1, 2, NA, NaN, Inf))
    ```
