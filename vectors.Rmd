...
## Important Types of Atomic Vector {#important-types-of-atomic-vector}
...
## Using atomic vectors {#using-atomic-vectors}
...
1.  The nested set diagram for
    ...
    ```{r nested_set_1,echo=FALSE,cache.extra=tools::md5sum(file_nested_set_1),echo=FALSE,purl=FALSE}
...
1.  The nested set diagram for
    ...
    ```{r nested_set_2,echo=FALSE,eval=is_html,cache.extra=tools::md5sum(file_nested_set_2),echo=FALSE,purl=FALSE}
...
## Augmented Vectors {#augmented-vectors}
