...
For delays less than two hours, the relationship between the delay of the preceeding flight and the current flight is nearly a line.
...
[^delay]: We could address this isssue using a statistical model, but that is outside
