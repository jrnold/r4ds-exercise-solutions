...
One pattern in cancelled flights per day is that the number of cancelled flights increses with the total number of flights per day.
...
and average arrival delay and the proportion of concelled flights.
```{r}
