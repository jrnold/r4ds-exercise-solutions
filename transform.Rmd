...
The fastest flight is the one with the average [ground speed](https://en.wikipedia.org/wiki/Ground_speed), wich can be calculated from the distance and duration of the flight.
