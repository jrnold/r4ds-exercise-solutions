...
Other than data errors, I can think of two reasons why `air_time` woud not equal `arr_time - dep_time`.
...
1.  The flight crosses time zones, and the total air time will be off by hours (multiples of 60). 
    ...
    120 minutes (Mountain), 180 minutes (Pacific), 240 minutes (Alaska), or 300 minutes (Hawaii-Aluetian).
...
The discrepency should be 180 minutes.
```{r}
