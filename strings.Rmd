...
1.  The *stringi* package contains several functions beginning with `stri_rand_*` that generate random text.
    ...
    Lorem ipsum text is nonsence placeholder text often used in publishing.
...
In this example from the `stri_sort()` documention, the sorted order of the character vector depends on the locale.
```{r}
