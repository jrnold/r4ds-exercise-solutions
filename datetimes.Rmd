...
First, I create a binary variable `early` that is create 1 if a flight leaves early, and 0 if it does not.
Then, I grouping flights by the minute of departure.
