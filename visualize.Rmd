...
The following code add rows for missing combiantions of `class` and `drv` and uses 
...
You can also add axis labels with `xlab()`, `ylab()`, and the scale fuctions, and titles with `ggtitle()`.
