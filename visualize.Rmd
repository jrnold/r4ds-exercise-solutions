...
The default message says that `stat_summary()` uses the `mean` and `sd` to calculate the middle point and endpoints of the line. So let's use the previous values of `fun.ymin`, `fun.ymax`, and `fun.y`:
```{r}
ggplot(data = diamonds) +
  geom_pointrange(
    mapping = aes(x = cut, y = depth),
