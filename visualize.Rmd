...
The `geom_abline()` geom adds a line to the plot with specified intercept and slope. The function `coord_fixed()` ensures that the line produced by `geom_abline()` is at a 45-degree angle.
