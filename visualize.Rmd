...
For me, it is difficult to distinguish the color of `"midsize"` points and that of `"minivan"` points.
...
Disadvantages of encoding `class` with facets instead of color are that the points for each category are on different plots,
...
The benefits of encoding a variable through facetting over color become more advantageous as either the number of points or the number of categories increase.
