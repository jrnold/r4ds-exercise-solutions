...
The function `separate()`, splits a column into multiple groups by separator, if the `sep` argument is a character vector, or by character positions, if `sep` is numeric.
```{r}
