...
You can perform one join after another like so. If duplicate variables are found, by default, dplyr will distinguish the two by adding `.x`, and `.y` to the ends of the variable names to solve naming conflicts. 
```{r}
flights %>%
...
flights %>%
  ...
  left_join(
    ...
    #existing lat and lon variables in tibble gains _origin suffix
