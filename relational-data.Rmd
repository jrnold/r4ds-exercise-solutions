...
Another option to draw database schema diagrams is the R package [datamodelr](https://github.com/bergant/datamodelr), which can programmatically create database schema digrams.
The following code uses **datamodelr** to create a diagram of the 
relations between the `Batting`, `Master`, and `Salaries` tables.
