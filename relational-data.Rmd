...
The reason for this discrepency may be that the `nycflights13` package gets the `flights` and `airports` data from different sources.
...
The BTS includes Puerto Rico and U.S. Virgin Islands as "domestic" (part of the US), while the [openflights.org](https://raw.githubusercontent.com/jpatokal/openflights/master/data/airports.dat) give use different values of country for airports in the US states (`"United States"`)  Puerto Rico (`"Puerto Rico"`) and US Virigin Islands (`"Virgin Islands"`).
