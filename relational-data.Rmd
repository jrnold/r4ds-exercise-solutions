...
1.  There is no primary key for `ggplot2::diamonds` since there is no combination of variables that uniquely identifies each observation.
    ...
    So we could create an arbritrary identifier for observations in the `diamonds` data set to use as a primary key.
...
I will start with clarifying the question. 
