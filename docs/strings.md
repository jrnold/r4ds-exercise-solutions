...
There is not a good way of doing this without creating a regular expression from the permutations of vowels.
...
1.  Generate random text. The *stringi* package contains several functions beginning with `stri_rand_`.
