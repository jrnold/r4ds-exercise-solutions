...
## For loop variations {#for-loop-variations}
...
## For loops vs. functionals {#for-loops-vs.functionals}
...
1.  To generate 10 random normals for each of $\mu = -10$, $0$, $10$, and $100$:
    ...
    vector that is only length one (see [Exercise 21.5.4]). 
...
## Mapping over multiple arguments {#mapping-over-multiple-arguments}
...
## Other patterns of for loops {#other-patterns-of-for-loops}
