...
A more general function for `~ x1 + x2` would not hardcode the specific levels in `x2`.
```{r}
...
As with the previous formula, first I'll write a function that hardcodes the levels of `x2`.
```{r}
...
we will soon start reimplementating all of the `matrix_model()` function.
